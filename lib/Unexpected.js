    ...
    var wrapped = function () {
        ...
        if (this._context.promise) {
            this._context.promise = this._context.promise.then(function () {
                return callChainingAssertion.call(that, instance, that._context.expectContext, name, args);
            });
            return this;
        }

        var result;
        result = callChainingAssertion.call(that, instance, that._context.expectContext, name, args);
...
function callChainingAssertion(unexpected, context, name, args) {
    ...
    wrappedExpect.standardErrorMessage = chainingStandardErrorMessage.bind(null, that._context);
