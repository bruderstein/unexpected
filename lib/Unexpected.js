...
Unexpected.prototype.clone = function () {
    ...
    // TODO: need to clone the assertionRoot too
...
function callAssertion(unexpected, name, args) {
    ...
    this._context.calledAssertions.push({ assertion: assertion, subject: subject, subjectType: subjectType, args: args });
    ...
    var result;
    try {
        result = assertion.handler.call({ flags: assertion.flags || {} }, wrappedExpect, subject, ...args);
    } catch (e) {
        if (e._isUnexpected) {
