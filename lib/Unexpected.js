...
Unexpected.prototype.lookupAssertionRule = function (subject, testDescriptionString, assertionCollectionName, args, requireAssertionSuffix) {
    var that = this;
...
function callAssertion(unexpected, context, name, args) {
    ...
    var assertionRule = unexpected.lookupAssertionRule(this._context.subject, name, 'assertionMethods', args);
    if (!assertionRule) {
